...
call s:highlight_group      ("Constant",       s:Purple,     s:Black)
call s:highlight_group      ("String",         s:Burgundy,   s:Black)
call s:highlight_group      ("Character",      s:Pink,       s:Black)
call s:highlight_group      ("Number",         s:SoftBlue,   s:Black)
call s:highlight_group      ("Boolean",        s:Yellow,     s:Black)
call s:highlight_group      ("Float",          s:SoftBlue,   s:Black)
call s:highlight_group      ("Identifier",     s:Beige,      s:Black)
call s:highlight_group      ("Function",       s:CoolPurple, s:Black)
call s:highlight_group      ("Statement",      s:Pink,       s:Black)
call s:highlight_group      ("Conditional",    s:SoftBlue,   s:Black)
call s:highlight_group      ("Repeat",         s:Purple,     s:Black)
call s:highlight_group      ("Label",          s:Purple,     s:Black)
call s:highlight_group      ("Operator",       s:DeepBlue,   s:Black)
call s:highlight_group      ("Keyword",        s:CoolPurple, s:Black)
...
call s:highlight_group_style("Type",           s:Pink,       s:Black, "bold")
call s:highlight_group      ("StorageClass",   s:SoftBlue,   s:Black)
call s:highlight_group      ("Structure",      s:Blue,       s:Black)
call s:highlight_group      ("Typedef",        s:DeepBlue,   s:Black)
call s:highlight_group      ("Special",        s:Gray,       s:Black)
call s:highlight_group      ("SpecialChar",    s:Pink,       s:Black)
call s:highlight_group      ("Delimiter",      s:SoftBlue,   s:Black)
call s:highlight_group      ("SpecialComment", s:Black,      s:LightGray)
call s:highlight_group      ("Debug",          s:Gray,       s:Black)
call s:highlight_group_style("Underlined",     s:Gray,       s:Black, "underline")
...
call s:highlight_group      ('Cursor',         s:LightGray,  s:Black)
...
call s:highlight_group      ('vimOption',      s:Purple,     s:Black)
call s:highlight_group      ('pythonBuiltin',  s:Gray,       s:Black)
call s:highlight_group      ('pythonFunction', s:Gray,       s:Black)
