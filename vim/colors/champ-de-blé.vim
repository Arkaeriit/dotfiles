...
call s:highlight_group      ("Constant",       s:SoftBlue,  s:clear)
call s:highlight_group      ("String",         s:Blue,      s:clear)
call s:highlight_group      ("Character",      s:DeepBlue,  s:clear)
call s:highlight_group      ("Number",         s:ColdMoss,  s:clear)
call s:highlight_group      ("Boolean",        s:DarkBlood, s:clear)
call s:highlight_group      ("Float",          s:ColdMoss,  s:clear)
call s:highlight_group      ("Identifier",     s:Blue,      s:clear)
call s:highlight_group      ("Function",       s:DeepBlue,  s:clear)
call s:highlight_group      ("Statement",      s:SoftBlue,  s:clear)
call s:highlight_group      ("Conditional",    s:DarkBlue,  s:clear)
call s:highlight_group      ("Repeat",         s:SoftBlue,  s:clear)
call s:highlight_group      ("Label",          s:DarkBlood, s:clear)
call s:highlight_group      ("Operator",       s:DarkBlood, s:clear)
call s:highlight_group      ("Keyword",        s:Grass,     s:clear)
call s:highlight_group      ("Exception",      s:Burgundy,  s:clear)
...
call s:highlight_group_style("Type",           s:Moss,      s:clear,  "bold")
call s:highlight_group      ("StorageClass",   s:SoftBlue,  s:clear)
call s:highlight_group      ("Structure",      s:Grass,     s:clear)
call s:highlight_group      ("Typedef",        s:ColdMoss,  s:clear)
call s:highlight_group      ("Special",        s:Grass,     s:clear)
call s:highlight_group      ("SpecialChar",    s:DeepBlue,  s:clear)
call s:highlight_group      ("Delimiter",      s:SoftBlue,  s:clear)
call s:highlight_group      ("SpecialComment", s:Moss,      s:Gray)
call s:highlight_group      ("Debug",          s:Burgundy,  s:clear)
call s:highlight_group_style("Underlined",     s:clear,     s:clear, "underline")
call s:highlight_group      ("Error",          s:Red,       s:clear)
call s:highlight_group      ("Todo",           s:Gray,      s:Yellow)

" UI groups
call s:highlight_group      ('Visual',         s:Oak,       s:SoftBlue)
call s:highlight_group      ('Cursor',         s:Dust,      s:Oak)
...
call s:highlight_group      ("MatchParen",     s:SoftBlue,  s:clear)

" Language specific groups
call s:highlight_group      ('vimOption',      s:DeepBlue,  s:clear)
call s:highlight_group      ('pythonBuiltin',  s:DarkGray,  s:clear)
call s:highlight_group      ('pythonFunction', s:DarkGray,  s:clear)
