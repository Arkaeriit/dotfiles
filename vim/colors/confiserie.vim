...
call s:highlight_group      ("Constant",       s:PowerPurple, s:clear)
call s:highlight_group      ("String",         s:Gum,         s:clear)
call s:highlight_group      ("Character",      s:Pink,        s:clear)
call s:highlight_group      ("Number",         s:SoftBlue,    s:clear)
call s:highlight_group      ("Boolean",        s:CoolYellow,  s:clear)
call s:highlight_group      ("Float",          s:SoftBlue,    s:clear)
call s:highlight_group      ("Identifier",     s:SkyBlue,     s:clear)
call s:highlight_group      ("Function",       s:Sand,        s:clear)
call s:highlight_group      ("Statement",      s:Sand,        s:clear)
call s:highlight_group      ("Conditional",    s:Salmon,      s:clear)
call s:highlight_group      ("Repeat",         s:Magenta,     s:clear)
call s:highlight_group      ("Label",          s:Magenta,     s:clear)
call s:highlight_group      ("Operator",       s:Gum,         s:clear)
call s:highlight_group      ("Keyword",        s:Gum,         s:clear)
call s:highlight_group      ("Exception",      s:Beige,       s:clear)
...
call s:highlight_group      ("StorageClass",   s:PowerPurple, s:clear)
call s:highlight_group      ("Structure",      s:CoolPurple,  s:clear)
call s:highlight_group      ("Typedef",        s:PowerPurple, s:clear)
call s:highlight_group      ("Special",        s:SkyBlue,     s:clear)
...
call s:highlight_group      ('vimOption',      s:Gum,         s:clear)
call s:highlight_group      ('pythonBuiltin',  s:LightGray,   s:clear)
call s:highlight_group      ('pythonFunction', s:LightGray,   s:clear)
