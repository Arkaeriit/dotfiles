...
call s:highlight_group      ("Constant",       s:DeepBlue,    s:clear)
call s:highlight_group      ("String",         s:Burgundy,    s:clear)
call s:highlight_group      ("Character",      s:DarkBlue,    s:clear)
call s:highlight_group      ("Number",         s:Charcoal,    s:clear)
call s:highlight_group      ("Boolean",        s:Burgundy,    s:clear)
call s:highlight_group      ("Float",          s:Charcoal,    s:clear)
call s:highlight_group      ("Identifier",     s:DarkBlue,    s:clear)
call s:highlight_group      ("Function",       s:DarkBlue,    s:clear)
call s:highlight_group      ("Statement",      s:BlueBerry,   s:clear)
call s:highlight_group      ("Conditional",    s:PowerPurple, s:clear)
call s:highlight_group      ("Repeat",         s:BlackBerry,  s:clear)
call s:highlight_group      ("Label",          s:BlackBerry,  s:clear)
call s:highlight_group      ("Operator",       s:Purple,      s:clear)
call s:highlight_group      ("Keyword",        s:PowerPurple, s:clear)
call s:highlight_group      ("Exception",      s:Purple,      s:clear)
...
call s:highlight_group_style("Type",           s:Syrup,       s:clear, "bold")
call s:highlight_group      ("StorageClass",   s:Gum,         s:clear)
call s:highlight_group      ("Structure",      s:BlackBerry,  s:clear)
call s:highlight_group      ("Typedef",        s:BlackBerry,  s:clear)
call s:highlight_group      ("Special",        s:BlueBerry,   s:clear)
call s:highlight_group      ("SpecialChar",    s:Pink,        s:clear)
call s:highlight_group      ("Delimiter",      s:BlueBerry,   s:clear)
call s:highlight_group      ("SpecialComment", s:Gum,         s:LightGray)
call s:highlight_group      ("Debug",          s:Red,         s:clear)
...
call s:highlight_group      ('vimOption',      s:PowerPurple, s:clear)
